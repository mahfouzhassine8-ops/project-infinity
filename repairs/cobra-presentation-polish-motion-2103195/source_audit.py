...
def main():
    ...
    checks={
      'exact_2103194_parent':patch.get('base_build')==2103194 and patch.get('base_commit')=='e37d8a166fa8afd3aa2013b8fc5d235e1905983a',
      ...
      'sheet_motion':'scaleX(.985f)' in sheet and 'DecelerateInterpolator' in sheet and 'playerHub' in sheet,
