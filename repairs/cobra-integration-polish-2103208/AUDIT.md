# Cobra 2103208 — scoped integration polish candidate

Parent: the exact locked 2103207 APK, SHA-256 `de2afee4b5e56ee32cb7332f19ac5086b73ffd5c05c14da91eaa477971777eb2`, source commit `872dfe64b6710a478e7fd1b6625d1e03a7f9d1cf`.

This is a successor test candidate, not a replacement lock or a claim of physical acceptance. The earlier branch-head follow-up was not the locked parent: its two NORMAL-versus-NONE tests failed. This recipe reconstructs the exact passed parent and runs all 691 original cases before applying 208.
...
- All 49 inherited protected source members remain byte-identical, as do native source diffs. No native compile or SMALI mutation.
- APK native libraries/assets and unrelated resources remain byte-identical. The one authorized exception is an exact list of existing icon PNG payloads in `approved-resources.json`, each bound to its existing named resource/configuration, old/new SHA-256 and unchanged dimensions. Resource IDs, resource table and adaptive XML remain unchanged. This is not a blanket resource exemption.
...
Keep the exact pre-change 2103207 rollback bundle/source/evidence and same certificate. Install as an update only; never uninstall or clear data. Android may reject a lower version code after 208. Do not force a downgrade; restore via a separately reviewed, same-signer forward-version recovery when needed.
