...
public class Cobra2103194FoldAdaptiveAspectTest {
 ...
 @Test public void coverLikeViewportFitsEntireFrame(){float[] s=InfinityLiveActivity.CobraFoldAspectPolicy.scale(1920,1080,1f,904,2316);assertEquals(1f,s[0],.001f);assertTrue(s[1]>0f&&s[1]<1f);}
