...
def main():
    ...
    checks={
      ...
      'rebuffer_burst_preempts_permanent_stall':'mCobraRebufferBurstCount<3' in burst and '12000L' in burst and 'rebuffer-burst' in burst and 'seekToDefaultPosition' in burst,
