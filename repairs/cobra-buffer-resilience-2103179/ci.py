...
def upgrade():
 ...
 data.update(
   ...
   timeshift_stall_recovery=True,timeshift_stall_detect_ms=6000,rebuffer_burst_observation_only=True,rebuffer_burst_count=3,rebuffer_burst_window_ms=12000,auto_live_edge_first=True,auto_live_edge_verify_ms=2500,auto_live_edge_max_attempts=2,auto_live_edge_cooldown_ms=60000,buffering_media_restart_forbidden=True,manual_live_seek_equivalent=True,performance_overlay_source_aware=True,
...
def verify():
 ...
 with zipfile.ZipFile(base) as old,zipfile.ZipFile(final) as new:
  ...
  for token in (
    ...
    b"CobraTimeshiftStallPolicy",b"stall-detected",b"auto-live-edge-seek",
    b"rebuffer-burst-observed",b"no_restart=true",b"stall-persists-after-live-edge",
    b"error_path_owns_restart=true",b"auto_live_edge_recoveries",
 ...
 result={
  ...
  "auto_live_edge_max_attempts":2,"auto_live_edge_cooldown_ms":60000,
  "buffering_media_restart_forbidden":True,"manual_live_seek_equivalent":True,
