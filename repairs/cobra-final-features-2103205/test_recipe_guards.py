...
class RecipeGuards(unittest.TestCase):
    def setUp(self):
        ...
        self.test_name = 'tests/Cobra2103205GuardTest.java'
        ...
        self.review = {
            'status': 'frozen', 'parent_build': 2103204, 'parent_commit': recipe.PARENT_COMMIT,
            ...
            'inherited_android_cases': 500, 'parent_source_files': 220, 'new_source_files': 0,
        }
