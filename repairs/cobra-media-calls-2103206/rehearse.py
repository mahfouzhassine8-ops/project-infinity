...
PARENT_ZIP_SHA256 = '4736179b686faaf6446f9f65ffb031bce65f250f58de0ff9faf71d2fbe1f5553'
...
def rehearse(parent_zip, parent_receipt, candidate, out):
    ...
    with zipfile.ZipFile(parent_zip) as archive:
        ...
        require(archive.testzip() is None and len(names) == len(set(names)) == 226,
    ...
    for old, new in [('versionCode 2103205', 'versionCode 2103206'),
                     ('versionName "1.0.9-Cobra-Final-Features-RC1"',
                      'versionName "1.0.9-Cobra-Media-Calls-RC1"')]:
    ...
    result = {
        ...
        'parent_build': 2103205, 'parent_commit': review['parent_commit'],
        ...
        'declared_android_cases': 637 + review['new_android_cases'],
