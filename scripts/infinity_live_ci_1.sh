...
python3 -m py_compile scripts/infinity_1_0_9_live_release.py scripts/verify_infinity_live.py \
  scripts/verify_infinity_live_apk.py scripts/infinity_upper_layer_repack.py \
  scripts/infinity_player_rotation.py scripts/verify_infinity_player_rotation_apk.py \
  scripts/infinity_1_0_8_deep_rebrand.py scripts/infinity_1_0_8_deep_audio_rebrand.py \
...
grep -q 'versionCode 2103127' kodi/tools/android/packaging/xbmc/build.gradle.in
grep -q 'versionName "1.0.9-Live-Candidate-1"' kodi/tools/android/packaging/xbmc/build.gradle.in
